document.addEventListener("DOMContentLoaded", function () {
    ...
    mobileMenuBtn === null || mobileMenuBtn === void 0 ? void 0 : mobileMenuBtn.addEventListener("click", function () {
    ...
    // lomba navs
    var infografisIndex = 0, esaiIndex = 0;
    ...
    var infoLeft = lombaInfografis.querySelector(".slide-navigation.left-slide");
    var infoRight = lombaInfografis.querySelector(".slide-navigation.right-slide");
