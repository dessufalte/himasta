        ...
        <header class="bg-white/80 backdrop-blur-lg sticky top-0 z-50 shadow-sm">
            <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
                <a href="/" class="flex items-center gap-3 text-2xl font-bold text-navy-900">
                    <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Epsilon Logo" class="h-10 w-10" />
                    <span>EPSILON</span>
                </a>
                ...
                <div class="hidden lg:flex items-center gap-4">
                    <a href="<?php echo e(route('login')); ?>" class="px-6 py-2 rounded-lg font-semibold text-white bg-orange-600 hover:bg-orange-700 transition-all shadow-md hover:shadow-lg">Login</a>
                </div>
            ...
            <div id="mobile-menu" class="hidden lg:hidden bg-white p-6 absolute top-full left-0 w-full shadow-md">
                <div class="flex flex-col gap-6 text-lg font-medium">
                    ...
                    <div class="border-t border-slate-200 pt-6 flex flex-col gap-4">
                         <a href="<?php echo e(route('login')); ?>" class="w-full text-center px-6 py-3 rounded-lg font-semibold text-white bg-orange-600 hover:bg-orange-700 transition-all">Login</a>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="container mx-auto px-6">
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="relative flex justify-center items-center h-full">
                            ...
                            <img src="<?php echo e(asset('assets/img/maskot.png')); ?>" alt="Epsilon Mascot" class="relative w-3/4 max-w-md lg:w-full z-10 drop-shadow-2xl"/>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container mx-auto px-6 text-center">
                    ...
                    <div class="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
                            <img src="<?php echo e(asset('assets/img/slide/nsic.png')); ?>" alt="Lomba NSIC" class="rounded-lg mb-6 w-full h-48 object-cover">
                        ...
                        <!-- Lomba Card 2: NDAC -->
                        <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
                            <img src="<?php echo e(asset('assets/img/slide/ndac.png')); ?>" alt="Kompetisi NDAC" class="rounded-lg mb-6 w-full h-48 object-cover">
                        ...
                        <!-- Lomba Card 3: SSIC -->
                        <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
                            <img src="<?php echo e(asset('assets/img/slide/ssic.png')); ?>" alt="Kompetisi SSIC" class="rounded-lg mb-6 w-full h-48 object-cover">
                ...
                <div class="grid lg:grid-cols-3 gap-12">
                    <div class="space-y-4">
                        <a href="/" class="flex items-center gap-3 text-2xl font-bold">
                            <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Epsilon Logo" class="h-10 w-10 bg-white rounded-full p-1" />
                            <span>EPSILON</span>
                        </a>
...
<?php /**PATH D:\DOKUMEN PENTING\PROJECT WEBS\himasta\htdocs\resources\views/welcome.blade.php ENDPATH**/ ?>