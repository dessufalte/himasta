  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <!-- Left navbar cookie -->
            <script src="<?php echo e(asset('assets/js/sidebar-cookie.js')); ?>"></script>
        </div>
    </div>
  </div>
...
<?php /**PATH D:\DOKUMEN PENTING\PROJECT WEBS\himasta\htdocs\resources\views/user/components/master.blade.php ENDPATH**/ ?>