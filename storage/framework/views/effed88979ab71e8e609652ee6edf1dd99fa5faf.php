        ...
        <tbody>
            ...
            <?php $__currentLoopData = $kategori_lomba; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <?php if($k->upload_pembayaran): ?>
                            <a href="<?php echo e(route('admin.download.bukti.pembayaran', ['filename' => $k->upload_pembayaran])); ?>"
                    ...
                    <td>
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('admin.status.pendaftaran', $k->id_kategori)); ?>"
...
<?php /**PATH /home/epstat/htdocs/resources/views/admin/pendaftaran_lomba.blade.php ENDPATH**/ ?>